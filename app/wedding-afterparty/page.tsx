...
const faqItems = [
  ...
  },
  {
    ...
    answer: '沖縄の結婚式二次会は、飲み放題込みで1名あたり3,500〜6,000円が相場です。50名・100名などの人数規模や、会場のグレードによって変わります。会場使用料が無料の会場も多くあります。',
  },
  {
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {[
                ...
                { size: '120名以上', price: '4,000〜6,000円', room: '無料〜100,000円' },
              ].map((row, i) => (
