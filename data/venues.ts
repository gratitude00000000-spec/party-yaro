...
export const venues: Venue[] = [
  ...
  },
  {
    ...
    facilities: ['貸切OK', '飲み放題', '音響', 'カラオケ', 'ダーツ', '深夜OK'],
    scenes: ['結婚式二次会', '歓送迎会', '忘年会', '新年会', '同窓会', '会社イベント', 'DJイベント'],
  ...
  },
  {
    ...
    description:
      '那覇・安里に構える沖縄の雰囲気たっぷりのバー。店内の一角を貸切スペースとしてご利用いただけます。琉球の文化と空気感を感じられる空間で、本格ステージを完備。カラオケ・ダーツ・音響設備が揃い、二次会から歓送迎会・同窓会まで沖縄らしいひとときをお楽しみいただけます。',
    images: [
    ...
    phone: PHONE,
    recommendedPoint:
      '沖縄らしい雰囲気を味わえる那覇・安里のバー。店内の貸切スペースはステージを備えており、余興や生演奏など盛りだくさんの演出が可能。ゆいレール安里駅から徒歩3分・国際通りも徒歩圏内でアクセス抜群。カラオケ・ダーツ・音響完備で、最大60名（立食100名）まで対応します。',
    faq: [
      {
  ...
  },
  {
    ...
    capacityMin: 20,
    capacityMax: 80,
    priceText: 'お問い合わせください',
    description:
      '那覇・久茂地エリアの居酒屋スタイルパーティー会場。充実したフードメニューと飲み放題で、歓送迎会・忘年会・各種パーティーを盛り上げます。',
    images: [],
    tags: ['貸切OK', '那覇', '飲み放題', 'フードが充実'],
    facilities: ['貸切OK', '飲み放題', 'フードが充実'],
    scenes: ['歓送迎会', '忘年会', '新年会', '同窓会', '会社イベント'],
    access: '那覇市久茂地エリア',
    mapUrl: 'https://maps.google.com/?q=那覇市久茂地',
    lineUrl: LINE_URL,
    phone: PHONE,
    recommendedPoint:
      '充実したフードと飲み放題が自慢の久茂地エリアの貸切会場。ぱーてぃー野郎スタッフが詳細をご案内します。',
    faq: [
      {
        question: '貸切は何名から可能ですか？',
        answer: '20名様からご利用いただけます。ぱーてぃー野郎スタッフが最適なプランをご提案します。',
      },
      {
        question: '二次会の幹事サポートはありますか？',
        answer: 'ぱーてぃー野郎の専任スタッフが、会場選びから当日の進行まで無料でサポートします。',
      },
    ],
    isFeatured: false,
  },
  {
    ...
    priceText: 'お問い合わせください',
    description:
      '那覇・国場エリアの居酒屋スタイルパーティー会場。豊富なフードメニューと飲み放題プランで、地元の方に親しまれています。',
    images: [],
    tags: ['貸切OK', '那覇', '飲み放題', 'フードが充実'],
    facilities: ['貸切OK', '飲み放題', 'フードが充実'],
    scenes: ['歓送迎会', '忘年会', '新年会', '同窓会', '会社イベント'],
    access: '那覇市国場エリア',
    mapUrl: 'https://maps.google.com/?q=那覇市国場',
    lineUrl: LINE_URL,
    phone: PHONE,
    recommendedPoint:
      '充実したフードと飲み放題が自慢の国場エリアの貸切会場。ぱーてぃー野郎スタッフが詳細をご案内します。',
    faq: [
      {
        question: '貸切は何名から可能ですか？',
        answer: '20名様からご利用いただけます。ぱーてぃー野郎スタッフが最適なプランをご提案します。',
  ...
  },
  {
    ...
    priceText: 'お問い合わせください',
    description:
      '浦添・港川エリアの居酒屋スタイルパーティー会場。充実したフードと飲み放題で、歓送迎会・忘年会などあらゆるシーンに対応します。',
    images: [],
    tags: ['貸切OK', '浦添', '飲み放題', 'フードが充実'],
    facilities: ['貸切OK', '飲み放題', 'フードが充実'],
    scenes: ['歓送迎会', '忘年会', '新年会', '同窓会', '会社イベント'],
    access: '浦添市港川エリア',
    mapUrl: 'https://maps.google.com/?q=浦添市港川',
    lineUrl: LINE_URL,
    phone: PHONE,
    recommendedPoint:
      '充実したフードと飲み放題が自慢の港川エリアの貸切会場。ぱーてぃー野郎スタッフが詳細をご案内します。',
    faq: [
      {
        question: '貸切は何名から可能ですか？',
        answer: '20名様からご利用いただけます。ぱーてぃー野郎スタッフが最適なプランをご提案します。',
  ...
  },
  {
    ...
    priceText: 'お問い合わせください',
    description:
      '豊見城エリアのフード充実の貸切パーティー会場。充実した料理メニューと飲み放題で、地域密着のパーティーをサポートします。',
    images: [],
    tags: ['貸切OK', '豊見城', '飲み放題', 'フードが充実'],
    facilities: ['貸切OK', '飲み放題', 'フードが充実'],
    scenes: ['歓送迎会', '忘年会', '新年会', '同窓会', '会社イベント'],
    access: '豊見城市内',
    mapUrl: 'https://maps.google.com/?q=豊見城市',
    lineUrl: LINE_URL,
    phone: PHONE,
    recommendedPoint:
      '豊見城エリアのフード充実の貸切会場。詳細はぱーてぃー野郎スタッフまでお気軽にLINEでご相談ください。',
    faq: [
      {
        question: '貸切は何名から可能ですか？',
        answer: '20名様からご利用いただけます。ぱーてぃー野郎スタッフが最適なプランをご提案します。',
  ...
  },
  {
    ...
    priceText: 'お問い合わせください',
    description:
      '北谷エリアのフード充実の貸切パーティー会場。充実した料理と飲み放題で、観光客にも地元の方にも人気のパーティー会場です。',
    images: [],
    tags: ['貸切OK', '北谷', '飲み放題', 'フードが充実'],
    facilities: ['貸切OK', '飲み放題', 'フードが充実'],
    scenes: ['歓送迎会', '忘年会', '新年会', '同窓会', '会社イベント'],
    access: '北谷町内',
    mapUrl: 'https://maps.google.com/?q=北谷町',
    lineUrl: LINE_URL,
    phone: PHONE,
    recommendedPoint:
      '北谷エリアのフード充実の貸切会場。詳細はぱーてぃー野郎スタッフまでお気軽にLINEでご相談ください。',
    faq: [
      {
        question: '貸切は何名から可能ですか？',
        answer: '20名様からご利用いただけます。ぱーてぃー野郎スタッフが最適なプランをご提案します。',
