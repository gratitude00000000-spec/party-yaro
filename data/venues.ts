...
export const venues: Venue[] = [
  ...
  },
  {
    ...
    facilities: ['貸切OK', '飲み放題', 'フードが充実', 'プロジェクター', '音響', 'カラオケ', '駐車場'],
    scenes: ['結婚式二次会', '歓送迎会', '忘年会', '新年会', '同窓会', '会社イベント'],
  ...
  },
  {
    ...
    facilities: ['貸切OK', '飲み放題', 'フードが充実', 'プロジェクター', '音響', '駐車場', '深夜OK'],
    scenes: ['結婚式二次会', '歓送迎会', '忘年会', '新年会', '同窓会', '会社イベント', 'DJイベント'],
  ...
  },
  {
    ...
    facilities: ['貸切OK', '飲み放題', 'フードが充実', 'プロジェクター', '音響', 'カラオケ', '深夜OK'],
    scenes: ['結婚式二次会', '歓送迎会', '忘年会', '新年会', '同窓会', '会社イベント', 'DJイベント'],
    ...
    websiteUrl: 'https://station-bbq.com/',
  },
  {
    id: '20',
    name: 'STATION 国場店',
  ...
  },
  {
    ...
    priceText: '¥3,500〜 / 1名（飲み放題込）',
    description:
      '最大150名様OK！結婚式2次会に特化した大型パーティースペース。大人空間で仕切りのない一体感のあるレイアウトは、ゲスト同士の交流を深めるのにぴったり。大型モニターやメインステージ、マイク、音響などの設備も充実。モーリアクラシック沖縄迎賓館／結婚式場NBCより車で10分圏内、周辺にはカラオケや飲み屋街など3次会へのロケーションも最高です。',
    images: [
    ...
    phone: PHONE,
    recommendedPoint:
      '幹事様・新郎新婦様は、当日を楽しむだけ。Music Bar KINGでは、結婚式二次会や同窓会を成功へ導くお任せプランをご用意。司会進行・ゲーム企画・景品・入場演出（スモークなど）までトータルプロデュース。最大150名対応の大型貸切空間で、忘れられない一日を演出します。さらに100名様以上のご利用で東京ディズニーリゾート®ペアチケットをプレゼント！',
    faq: [
      {
  ...
  },
  {
    ...
    images: [
      ...
      '/venues/partyspace-next-2.jpg',
      '/venues/partyspace-next-3.jpg',
      '/venues/partyspace-next-4.jpg',
      '/venues/partyspace-next-5.jpg',
    ],
    ...
    websiteUrl: 'https://partyspace-next-naha.com/',
